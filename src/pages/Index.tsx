...
const Index = () => {
  const musicCards = [
    {
      id: 1,
      image: "/img/e0c2d91e-b30c-47f1-87d5-2da7c4828c60.jpg",
      title: "Цветы",
      artist: "Темный принц",
...
Под пледом с тобой одним`,
    ...
    {
      id: 2,
      image: "/img/8cfb723f-acff-4c77-9c44-7c45d095f134.jpg",
      title: "Городские огни",
      artist: "Модерн",
      lyrics: `Неоновые огни зажглись,
Город не спит до утра,
Мы идем по пустым улицам,
В поисках смысла и добра.

Асфальт отражает звезды,
Машины несутся вдаль,
Но в сердце живет надежда,
Что найдем свою мечту.`,
    },
    {
      id: 3,
      image: "/img/60151213-ba40-42c8-8fbe-c1dc010673e9.jpg",
      title: "Старые пластинки",
      artist: "Ретро",
      lyrics: `Пластинка крутится на проигрывателе,
Звуки прошлого оживают,
Мы вспоминаем те дни,
Когда музыка душу согревала.

Треск и шорох винила,
Тепло ламповых усилителей,
Эти мелодии навсегда,
