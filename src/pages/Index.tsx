...
Которое мы можем созерцать.`,
    ...
    {
      id: 4,
      image: "/img/299f71ec-463d-4407-acff-cd1e2f25edb0.jpg",
      title: "Мурашки",
      artist: "Жанулька",
...
Эта песня о чувствах и эмоциях,
которые пробегают по коже
как мурашки от прикосновения
музыки к душе.`,
    },
    {
      id: 5,
      image: "/img/3c23ba2c-4155-4b1a-a6b4-c6ec97f2d4ea.jpg",
      title: "Исповедь",
      artist: "OOES",
      lyrics: `[Текст песни требует авторизации]
...
Искренняя исповедь в музыкальной форме,
где каждое слово идет от сердца
и рассказывает о самом личном
и важном в жизни.`,
    },
  ];
